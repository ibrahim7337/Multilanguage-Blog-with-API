                            ...
                            <div class="card-block">
                                <form action="" method="post">
                                    <div class="form-group col-md-6">
                                        ...
                                        <img src="{{asset($setting->logo)}}" alt="" style='height: 50px ; border-radius:50%'>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">{{__('words.logo')}}</label>
                                        <img src="{{asset($setting->favicon)}}" alt="" style='height: 50px ; border-radius:50%'>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">{{__('words.logo')}}</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="">{{__('words.facebook')}}</label>
                                        <input type="text" name="facebook" class="form-control"
                                        placeholder="{{__('words.facebook')}}" value ="{{$setting->facebook}}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">{{__('words.instagram')}}</label>
                                    ...
                                    <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif"
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="{{$key}}[content]" class="form-control" cols="30" rows="10">
                                                {{$setting->translate($key)->content}}</textarea>
                                        </div>
